...
/*2. Write a query that returns all customer purchases and a new calculated column 'price' (quantity m cost_to_customer_per_qty), 
...
SELECT vendor_id,
count (booth_number) AS 'number_of_times_vendor_rented_a_booth'
...
-- Date  This section of assignment is not done per direction from Thomas
